...
<div class="stats-grid" id="stats-grid">
  ...
  <div class="stat-card admin-card" id="stat-card-contact-messages" style="display:none;cursor:pointer;" onclick="window.location='/admin/contact-messages'">
    ...
    <div><div class="stat-value" id="stat-contact-messages">-</div><div class="stat-label">Unread Messages</div></div>
  </div>
