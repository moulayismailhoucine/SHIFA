    ...
    <div id="lab-result-panel" style="display:none;">
      <div class="glass-card">
        ...
        <div class="form-group">
          <label class="form-label">🤖 AI Analysis Type <span style="color:#94a3b8;font-size:11px;font-weight:400;">(for image uploads)</span></label>
          <select id="analysis-type" class="form-control">
            <option value="none">No AI Analysis (PDF / standard results)</option>
            <option value="skin">🔬 Skin Cancer Detection (skin lesion images)</option>
            <option value="fracture">🦴 Bone Fracture Detection (X-ray images)</option>
          </select>
        </div>
        <div class="form-group">
  ...
  grid.innerHTML = items.map(res => `
    <div style="border:1.5px solid #e2e8f0;border-radius:16px;overflow:hidden;background:#fff;box-shadow:0 2px 12px rgba(15,52,96,0.06);transition:box-shadow 0.2s;" onmouseover="this.style.boxShadow='0 8px 28px rgba(15,52,96,0.13)'" onmouseout="this.style.boxShadow='0 2px 12px rgba(15,52,96,0.06)'">
      ...
      <div style="padding:14px;">
        ...
        ${res.note ? `<div style="font-size:11.5px;color:#64748b;margin-bottom:8px;border-left:3px solid #f59e0b;padding-left:8px;white-space:pre-wrap;">${res.note}</div>` : ''}
  ...
  container.innerHTML = data.map(res => `
    <div class="result-item">
      ...
      <div class="result-item-info">
        ...
        ${res.note ? `<div style="font-size:11px;color:#64748b;margin-top:4px;white-space:pre-wrap;">${res.note}</div>` : ''}
