...
<div id="doctor-modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:500;align-items:center;justify-content:center;">
  <div style="background:white;border-radius:20px;padding:32px;max-width:520px;width:95%;box-shadow:0 24px 80px rgba(0,0,0,0.3);">
    ...
    <form id="doctor-form">
      ...
      <div class="form-group"><label class="form-label"><i class="fas fa-map-marker-alt" style="color:#e94560;"></i> Clinic Address</label><input type="text" id="f-clinic-address" class="form-control" placeholder="e.g. 12 Rue Didouche, Alger"></div>
      ...
      <div class="form-grid">
        ...
        <div class="form-group"><label class="form-label">Break Start</label><input type="time" id="f-break-start" class="form-control"></div>
        <div class="form-group"><label class="form-label">Break End</label><input type="time" id="f-break-end" class="form-control"></div>
      </div>
...
function openModal(doc=null) {
  ...
  document.getElementById('f-clinic-address').value = doc?.clinic_address||'';
  ...
  document.getElementById('f-break-start').value = doc?.break_start||'12:00';
  document.getElementById('f-break-end').value = doc?.break_end||'13:00';
...
document.getElementById('doctor-form').addEventListener('submit', async function(e) {
  ...
  formData.append('clinic_address', document.getElementById('f-clinic-address').value);
  ...
  formData.append('break_start', document.getElementById('f-break-start').value);
  formData.append('break_end', document.getElementById('f-break-end').value);
