...
class DoctorController extends Controller
{
    ...
    public function update(Request $request, Doctor $doctor)
    {
        ...
        $doctorUpdate = [];
        foreach (['specialty', 'phone', 'license_number', 'bio', 'clinic_address', 'is_active', 'paid_amount', 'working_days', 'working_hours_start', 'working_hours_end', 'break_start', 'break_end', 'treatment_time'] as $field) {
    ...
    private function formatDoctor(Doctor $doctor): array
    {
        return [
            ...
            'break_start'         => $doctor->break_start ? substr($doctor->break_start, 0, 5) : null,
            'break_end'           => $doctor->break_end ? substr($doctor->break_end, 0, 5) : null,
