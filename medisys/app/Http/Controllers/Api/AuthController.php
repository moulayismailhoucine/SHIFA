...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        try {
            ...
            // Create web session so Blade/admin routes (which use the 'auth' middleware)
            // work correctly. The logout route (/logout) properly invalidates this session,
            // so the old "stale admin session" bug is fully resolved.
