...
class Patient extends Authenticatable
{
    ...
    public function nursingOrders()
    {
        return $this->hasMany(NursingOrder::class);
    }

    public function nurseAuditLogs()
    {
        return $this->hasMany(NurseAuditLog::class)->orderBy('created_at', 'desc');
    }
}
